...
while True:
    ...
    for i in range(len(url)):
        try:
            json_url = url[i].replace("http://steamcommunity.com/market/listings/730/",
            "http://steamcommunity.com/market/priceoverview/?country=DE&currency=1&appid=730&market_hash_name=")
